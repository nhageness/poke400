...
CREATE OR REPLACE TABLE NHAGENCO1.MOVES (
    ...
    MIN_HITS    SMALLINT       NOT NULL DEFAULT 1,  -- multi-hit: lower bound
    MAX_HITS    SMALLINT       NOT NULL DEFAULT 1,  -- multi-hit: upper bound
    PRIMARY KEY (MOVE_ID),
    FOREIGN KEY (TYPE_ID) REFERENCES NHAGENCO1.TYPES(TYPE_ID)
);

-- === NORMAL MOVES ===
INSERT INTO NHAGENCO1.MOVES VALUES (1,   'TACKLE',        1,  40,  100, 35, 'Y', NULL,      0, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (2,   'SCRATCH',       1,  40,  100, 35, 'Y', NULL,      0, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (3,   'POUND',         1,  40,  100, 35, 'Y', NULL,      0, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (4,   'BODY SLAM',     1,  85,  100, 15, 'Y', 'PARALYZE', 30, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (5,   'HYPER BEAM',    1, 150,   90,  5, 'Y', 'RECHARGE', 100, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (6,   'QUICK ATTACK',  1,  40,  100, 30, 'Y', 'PRIORITY', 100, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (7,   'SLASH',         1,  70,  100, 20, 'Y', 'HIGH CRIT', 100, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (8,   'STRENGTH',      1,  80,  100, 15, 'Y', NULL,      0, 1, 1);

-- === FIRE MOVES ===
INSERT INTO NHAGENCO1.MOVES VALUES (10,  'EMBER',         2,  40,  100, 25, 'N', 'BURN',    10, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (11,  'FLAMETHROWER',  2,  95,  100, 15, 'N', 'BURN',    10, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (12,  'FIRE BLAST',    2, 120,   85,  5, 'N', 'BURN',    30, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (13,  'FIRE SPIN',     2,  35,   85, 15, 'N', 'TRAP',   100, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (14,  'FIRE PUNCH',    2,  75,  100, 15, 'N', 'BURN',    10, 1, 1);

-- === WATER MOVES ===
INSERT INTO NHAGENCO1.MOVES VALUES (20,  'BUBBLE',        3,  20,  100, 30, 'N', NULL,      0, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (21,  'WATER GUN',     3,  40,  100, 25, 'N', NULL,      0, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (22,  'SURF',          3,  95,  100, 15, 'N', NULL,      0, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (23,  'HYDRO PUMP',    3, 120,   80,  5, 'N', NULL,      0, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (24,  'BUBBLE BEAM',   3,  65,  100, 20, 'N', 'SPD DOWN', 10, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (25,  'WITHDRAW',      3, NULL, 100, 40, 'N', 'DEF UP', 100, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (26,  'WATER PULSE',   3,  60,  100, 20, 'N', 'CONFUSE',  20, 1, 1);

-- === ELECTRIC MOVES ===
INSERT INTO NHAGENCO1.MOVES VALUES (30,  'THUNDER SHOCK', 4,  40,  100, 30, 'N', 'PARALYZE', 10, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (31,  'THUNDERBOLT',   4,  95,  100, 15, 'N', 'PARALYZE', 10, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (32,  'THUNDER',       4, 120,   70, 10, 'N', 'PARALYZE', 30, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (33,  'THUNDER WAVE',  4, NULL, 100, 20, 'N', 'PARALYZE',100, 1, 1);

-- === GRASS MOVES ===
INSERT INTO NHAGENCO1.MOVES VALUES (40,  'VINE WHIP',     5,  35,  100, 10, 'N', NULL,      0, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (41,  'RAZOR LEAF',    5,  55,   95, 25, 'N', 'HIGH CRIT',100, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (42,  'SOLAR BEAM',    5, 120,  100, 10, 'N', 'CHARGE',  100, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (43,  'LEECH SEED',    5, NULL,  90, 10, 'N', 'DRAIN',   100, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (44,  'SLEEP POWDER',  5, NULL,  75, 15, 'N', 'SLEEP',   100, 1, 1);

-- === ICE MOVES ===
INSERT INTO NHAGENCO1.MOVES VALUES (50,  'ICE BEAM',      6,  95,  100, 10, 'N', 'FREEZE',  10, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (51,  'BLIZZARD',      6, 120,   90,  5, 'N', 'FREEZE',  10, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (52,  'ICE PUNCH',     6,  75,  100, 15, 'N', 'FREEZE',  10, 1, 1);

-- === FIGHTING MOVES ===
INSERT INTO NHAGENCO1.MOVES VALUES (60,  'KARATE CHOP',   7,  50,  100, 25, 'Y', 'HIGH CRIT',100, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (61,  'LOW KICK',      7,  50,   90, 20, 'Y', NULL,      0, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (62,  'SUBMISSION',    7,  80,   80, 25, 'Y', 'RECOIL',  100, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (63,  'SEISMIC TOSS',  7, NULL, 100, 20, 'Y', 'FIXED DMG',100, 1, 1);

-- === POISON MOVES ===
INSERT INTO NHAGENCO1.MOVES VALUES (70,  'POISON STING',  8,  15,  100, 35, 'Y', 'POISON',  30, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (71,  'SLUDGE',        8,  65,  100, 20, 'Y', 'POISON',  30, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (72,  'TOXIC',         8, NULL,  85, 10, 'Y', 'BAD PSN', 100, 1, 1);

-- === GROUND MOVES ===
INSERT INTO NHAGENCO1.MOVES VALUES (80,  'DIG',           9,  80,  100, 10, 'Y', 'DIG',     100, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (81,  'EARTHQUAKE',    9, 100,  100, 10, 'Y', NULL,      0, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (82,  'SAND ATTACK',   9, NULL, 100, 15, 'Y', 'ACC DOWN',100, 1, 1);

-- === FLYING MOVES ===
INSERT INTO NHAGENCO1.MOVES VALUES (90,  'WING ATTACK',  10,  35,  100, 35, 'Y', NULL,      0, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (91,  'FLY',          10,  70,   95, 15, 'Y', 'FLY',     100, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (92,  'DRILL PECK',   10,  80,  100, 20, 'Y', NULL,      0, 1, 1);

-- === PSYCHIC MOVES ===
INSERT INTO NHAGENCO1.MOVES VALUES (100, 'CONFUSION',    11,  50,  100, 25, 'N', 'CONFUSE',  10, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (101, 'PSYCHIC',      11,  90,  100, 10, 'N', 'SPDEF DN', 30, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (102, 'DREAM EATER',  11, 100,  100, 15, 'N', 'DRAIN',   100, 1, 1);

-- === BUG MOVES ===
INSERT INTO NHAGENCO1.MOVES VALUES (110, 'STRING SHOT',  12, NULL,  95, 40, 'Y', 'SPD DOWN',100, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (111, 'PIN MISSILE',  12,  14,   85, 20, 'Y', NULL,      0, 2, 5);

-- === ROCK MOVES ===
INSERT INTO NHAGENCO1.MOVES VALUES (120, 'ROCK SLIDE',   13,  75,   90, 10, 'Y', 'FLINCH',  30, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (121, 'ROCK THROW',   13,  50,   90, 15, 'Y', NULL,      0, 1, 1);

-- === GHOST MOVES ===
INSERT INTO NHAGENCO1.MOVES VALUES (130, 'LICK',         14,  20,  100, 30, 'Y', 'PARALYZE', 30, 1, 1);
INSERT INTO NHAGENCO1.MOVES VALUES (131, 'NIGHT SHADE',  14, NULL, 100, 15, 'Y', 'FIXED DMG',100, 1, 1);

-- === DRAGON MOVES ===
INSERT INTO NHAGENCO1.MOVES VALUES (140, 'DRAGON RAGE',  15, NULL, 100, 10, 'N', 'FIXED 40', 100, 1, 1);
...
CREATE OR REPLACE TABLE NHAGENCO1.BATTLE_SESSION (
    ...
    P2_DMG      DECIMAL(7, 6),
    FIRST_ATK   SMALLINT,
    P1_ACTION      CHAR(1)   DEFAULT NULL,   -- 'M' = move, 'S' = switch
    P2_ACTION      CHAR(1)   DEFAULT NULL,
    P1_SWITCH_SLOT SMALLINT  DEFAULT NULL,   -- target TEAM_SLOT when action='S'
    P2_SWITCH_SLOT SMALLINT  DEFAULT NULL,
